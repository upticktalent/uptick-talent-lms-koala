...
Open .env.example file to see the list of environment variables used in this app. Create a .env and fill in your credentials.
...
2. Create a new branch. Read the Contributing.md file to understand our convention for creating a branch and making prs.
