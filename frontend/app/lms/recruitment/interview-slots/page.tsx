      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-3 w-full md:w-auto">
            <Link
              href="/lms/recruitment/interview-slots/create"
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-2 text-sm text-gray-600 mb-4">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span
                            className="font-medium text-blue-600 text-right max-w-[200px] truncate"
                            title={
                  ...
                  <TableBody>
                    {paginatedSlots.map((slot: any) => (
                      ...
                      >
                        ...
                        <TableCell className="py-4">
                          <div
                            className="text-sm text-blue-600 max-w-[250px] truncate"
                            title={
                              slot.tracks && slot.tracks.length > 0
                                ? slot.tracks
                                    .map((track: any) => track.name)
