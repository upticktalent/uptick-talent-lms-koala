  ...
  const announcements = [
    {
      ...
      content:
        "This week we'll be diving deep into JavaScript fundamentals including variables, functions, and control flow. Please review the pre-reading materials before our next session.",
      priority: 'high',
      authorId: 'mentor1',
    ...
    },
    {
      ...
      content:
        "Due to popular request, we're extending the deadline for Assignment 2 by 2 days. The new due date is Friday, November 22nd at 11:59 PM.",
      priority: 'medium',
      authorId: 'mentor1',
      authorName: 'John Smith',
    ...
    },
    {
      ...
      content:
        "Welcome everyone to the Frontend Development track! We're excited to have you on this journey. Over the next 12 weeks, you'll learn HTML, CSS, JavaScript, and React. Let's build amazing things together!",
      priority: 'low',
      authorId: 'mentor1',
      authorName: 'John Smith',
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='flex justify-between items-center'>
        ...
        {(isAdmin || isMentor) && <Button>New Announcement</Button>}
      </div>
