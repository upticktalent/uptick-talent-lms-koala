...
export default function TrackClassroomPage() {
  ...
  const materials = [
    {
      ...
      description: 'A comprehensive guide to HTML elements, attributes, and semantic markup.',
    ...
    },
    {
      ...
      description: 'Learn modern CSS layout techniques with practical examples.',
    ...
    },
    {
      ...
      description: 'Presentation covering arrow functions, destructuring, modules, and more.',
  ...
  const assignments = [
    ...
    },
    {
      ...
      description: 'Build a functional calculator application using vanilla JavaScript. Implement basic arithmetic operations and a clean user interface.',
  ...
  const getMaterialColor = (type: string) => {
    switch (type) {
      ...
      case 'slides': return 'bg-orange-100 text-orange-800';
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className={`px-2 py-1 text-xs rounded-full ${getMaterialColor(material.type)}`}>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-orange-600">
              {Math.round((assignments.reduce((acc, a) => acc + a.submissions, 0) / 
                (assignments.length * (assignments[0]?.totalStudents || 1))) * 100) || 0}%
            </div>
