...
export default function ClassworkPage() {
  ...
  if (cohortLoading || loading) return <Loader />;
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
        ...
        {userRole !== "student" && canCreateContent() && (
          <DropdownMenu
            ...
            onOpenChange={setShowCreateOptions}
          >
            ...
            <DropdownMenuContent align="end" className="w-56">
              <DropdownMenuItem onClick={handleCreateStream}>
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    Announcements, lessons, or updates
                  </div>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={handleCreateTask}>
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    Tasks, projects, quizzes, or readings
                  </div>
                </div>
              </DropdownMenuItem>
            </DropdownMenuContent>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 border border-gray-200 rounded-lg">
            <h3 className="font-semibold text-lg">
              All Classwork ({allClassworkItems.length})
            </h3>
          </div>
