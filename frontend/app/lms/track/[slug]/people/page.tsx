      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {filteredMentors.length === 0 ? (
            <Card>
              <CardContent className="pt-6 text-center text-gray-500">
                {searchTerm ? 'No mentors found matching your search.' : 'No mentors assigned to this track.'}
              </CardContent>
            </Card>
          ) : (
        ...
        <div className="space-y-4">
          ...
          {filteredStudents.length === 0 ? (
            <Card>
              <CardContent className="pt-6 text-center text-gray-500">
                {searchTerm ? 'No students found matching your search.' : 'No students enrolled in this track.'}
              </CardContent>
            </Card>
          ) : (
            <div className="space-y-3">
