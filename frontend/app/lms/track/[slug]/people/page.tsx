    ...
    <div className="max-w-4xl mx-auto p-6 space-y-10">
      ...
      <section>
        <div className="flex items-center justify-between border-b border-blue-600 pb-4 mb-4">
          <h2 className="text-3xl font-normal text-blue-600">Mentors</h2>
        </div>
        <div className="space-y-4">
          ...
          {(!track.mentors || track.mentors.length === 0) && (
            <p className="text-gray-500 italic">No Mentors assigned</p>
          )}
        </div>
      </section>
      ...
      <section>
        <div className="flex items-center justify-between border-b border-blue-600 pb-4 mb-4">
          <h2 className="text-3xl font-normal text-blue-600">
            {studentsLabel}
          </h2>
          <span className="text-blue-600 font-medium">
            {track?.track.students?.length || 0} students
          </span>
        </div>
        <div className="space-y-4">
          ...
          {(!track?.track.students || track?.track.students.length === 0) && (
