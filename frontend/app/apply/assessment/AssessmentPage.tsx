  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Please complete all questions below. Take your time and provide
          thoughtful answers.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className='space-y-8'>
            ...
            <div key={question._id} className='border rounded-lg p-6'>
              ...
              {(question.type === 'essay' || question.type === 'code') && (
                <textarea
                  ...
                  style={
                    question.type === 'code' ? { fontFamily: 'monospace' } : {}
                  }
                  required
                />
              )}
          ...
          <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
            <div className='text-yellow-800'>
              <strong>Important:</strong> Please review all your answers before
              submitting. You will not be able to modify your responses after
              submission.
            </div>
          </div>
