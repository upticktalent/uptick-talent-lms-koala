...
import { getToolsForTrack } from "@/utils/trackData";
          ...
          <CardContent className="p-8">
            ...
            {currentStep === "about" && (
              <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 border border-gray-100 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-600">
                      ...
                      <li className="flex items-start">
                        <div className="h-1.5 w-1.5 rounded-full bg-primary mt-2 mr-3 shrink-0" />
                        <span>
                          Individuals with zero to little professional
                          experience looking for structured guidance and
                          industry exposure.
                        </span>
                      </li>
                    </ul>
                ...
                {/* Cohort Information */}
                {activeCohort && (
                  <div className="bg-white border border-gray-200 shadow-sm rounded-lg p-6 mt-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      ...
                      <div className="flex items-center text-gray-500">
                        ...
                        {formatDate(activeCohort.startDate)}
                      </div>
                      <div className="flex items-center text-gray-500">
                        <span className="font-medium text-gray-900 mr-2">
                          Duration:
