...
export default function ApplicationStatusPage() {
  ...
  const fetchApplicationStatus = async () => {
    try {
      const response = await applicantService.getApplicationStatus(applicantId!);
  ...
  const getStatusInfo = (status: string) => {
    switch (status) {
      ...
      case 'shortlisted':
        return {
          label: 'Shortlisted',
          description: 'Congratulations! You have been shortlisted. Please check your email for the assessment link.',
      ...
      case 'under_review':
        return {
          label: 'Under Review',
          description: 'Your application and assessment are being reviewed by our team.',
          color: 'bg-blue-100 text-blue-800',
        };
      case 'interview_scheduled':
        return {
          label: 'Interview Scheduled',
          description: 'Your interview has been scheduled. Please check your email for details.',
          color: 'bg-purple-100 text-purple-800',
        };
      case 'accepted':
        return {
          label: 'Accepted',
          description: 'Congratulations! You have been accepted. Welcome to Uptick Talent!',
          color: 'bg-green-100 text-green-800',
        };
      case 'rejected':
        return {
          label: 'Application Unsuccessful',
          description: 'Unfortunately, your application was not successful this time. Thank you for your interest.',
  ...
  if (!applicant) {
    return (
      <Card>
        <CardContent className="pt-6">
          <div className="text-center">
            <div className="text-gray-600 font-medium mb-2">Application Not Found</div>
            <p className="text-gray-600 mb-4">
              We couldn&apos;t find your application. Please check the URL or submit a new application.
            </p>
            <Link href="/apply">
              <Button variant="outline">Submit New Application</Button>
            </Link>
        ...
        <CardContent className="space-y-6">
          <div className="bg-white border rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div>
                <span className="text-sm font-medium text-gray-700">Preferred Track:</span>
